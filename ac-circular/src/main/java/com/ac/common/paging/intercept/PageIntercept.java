package com.ac.common.paging.intercept;
...
public class PageIntercept implements Interceptor {
   ...
   /**
     ...
     * @return
     */
    private String getPageSql(PageResult<?> page, String sql) {
  ...
  private String getMysqlPageSql(PageResult<?> page, String sql) {
	return page.getMysqlPageSql(sql);
  }
...
/**
     ...
     */
    private void setTotalRecord(PageResult<?> page,
